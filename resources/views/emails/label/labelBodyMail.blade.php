<div>
    <p>
        Datos de la Hoja de Ruta: {{$roadMapCode}} - Fecha de creación: {{ date('d/m/Y', strtotime($orders[0]->created_at)) }}
        <br>
        Asignada al chofer: {{ $orders[0]->driver->name }} {{ $orders[0]->driver->lastName }}:
        <br>
    </p>
